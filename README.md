...
Веб-додаток для бронювання переговорних кімнат: реєстрація/авторизація, створення кімнат, ролі учасників (ADMIN/USER) та бронювання з перевіркою конфліктів часу.
